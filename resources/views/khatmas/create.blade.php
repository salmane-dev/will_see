    ...
    <form >
        @csrf
            ...
            <div class="col-8 offset-2">
                ...
                <div class="form-group row">
                    <label for="name" class="col-md-4 pl-0 mb-0"> peeps </label>
                    <input id="name" 
                            type="text"
                            class="form-control @error('') is-invalid @enderror" 
                            name="name" value="{{ old('name') }}" 
                            autocomplete="off" autofocus>
                            <small id="nameHelp" class="form-text text-muted">How many people will join this khatma</small>   
                    @error('name')
                            <strong class="danger">{{ $message }}</strong>
                    @enderror
                ...
                <div class="form-group row">
                    <label for="name" class="col-md-4 pl-0 mb-0"> Days </label>
                    <input id="name" 
                            type="text"
                            class="form-control @error('') is-invalid @enderror" 
                            name="name" value="{{ old('name') }}" 
                            autocomplete="off" autofocus>
                            <small id="nameHelp" class="form-text text-muted">for how long</small>   
                    @error('name')
                            <strong class="danger">{{ $message }}</strong>
                    @enderror
                </div>
